...
export class ServiceService {
  ...
  getHomePageServices() {
    const url = `${environment.apiUrl}homepage/public`;
  ...
  postReview(id,data) {
    ...
    return this.http.post(url + id+'/review',data,httpOptions);
  }
  getReview(id) {
    const url = this.apiUrl;
    ...
    return this.http.get(url +'review/'+ id ,httpOptions);
  }
}
