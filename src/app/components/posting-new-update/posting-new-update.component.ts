import { Component, OnInit, OnDestroy, ViewEncapsulation, ViewChild, EventEmitter, Output } from '@angular/core';
...
export class PostingNewUpdateComponent implements OnInit, OnDestroy {
