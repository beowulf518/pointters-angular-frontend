...
export class EditPasswordComponent implements OnInit {
  ...
  onSave() {
    ...
    if(this.form.get('new_pass').value !== this.form.get('new_pass_confirm').value){
      this.form.get('new_pass_confirm').setErrors({
        ...this.form.get('new_pass_confirm').errors,
        'confirm_missmatch': true,
      });
      return;
    }
    if(this.form.valid) {
