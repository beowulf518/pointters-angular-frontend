...
export class ServiceAddComponent implements OnInit {
  ...
  onSave() {
    ...
    if( this.service.fulfillmentMethod.shipment){
      ...
      delete this.service.fulfillmentMethod.address;
      delete this.service.fulfillmentMethod.parcel;
    }
  ...
  onPriceAdd() {
    if (this.price_unit.price > 0) {
      ...
      times = this.hours + this.days*24 + this.weeks*168
  ...
  onDeliveryMethod(str) {
    ...
    this.service.fulfillmentMethod.online = false;
    this.service.fulfillmentMethod.shipment = false;
    this.service.fulfillmentMethod.store = false;
    this.service.fulfillmentMethod.local = false;

    switch (str) {
      case "online":
        // this.service.fulfillmentMethod.online = true;
        this.service.fulfillmentMethod.online = !this.service.fulfillmentMethod
          .online;
        break;
      case "shipment":
        // this.service.fulfillmentMethod.shipment = true;
        this.service.fulfillmentMethod.shipment = !this.service
          .fulfillmentMethod.shipment;
        break;
      case "store":
        // this.service.fulfillmentMethod.store = true;
        this.service.fulfillmentMethod.store = !this.service.fulfillmentMethod
          .store;
        break;
      case "local":
        // this.service.fulfillmentMethod.local = true;
